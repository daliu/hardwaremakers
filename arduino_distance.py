...
fname = path+"mi_long.mp3" #change to another note as needed
note = AudioSegment.from_mp3(fname)

ser = serial.Serial('/dev/cu.usbmodem1411', 9600) # Establish the connection on a specific port, for windows use COMX with X the port number
